...
/** Simplified contact for our list */
...
// ═════════════════════════════════════════════════════════════════════════════
// STEP 1B: Contact Selection
// ═════════════════════════════════════════════════════════════════════════════

function StepContactSelection({
  onSelectContact,
}: {
  ...
  async function loadContacts() {
    try {
      // Dynamically load expo-contacts only when user chooses contacts path
    ...
    switch (step) {
      ...
      case 1:
        return flowPath === "contacts" ? (
          <StepContactSelection onSelectContact={handleSelectContact} />
        ) : (
          <StepManualEntry
            name={name}
